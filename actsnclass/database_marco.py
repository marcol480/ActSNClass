...
from actsnclass.classifiers_marco import random_forest_spark
...
__all__ = ['DataBase_marco']


class DataBase_marco:
    ...
    def classify(self, method='RandomForest'):
        ...
        if method == 'RandomForest':
            self.predicted_class,  self.classprob, self.features_importance = \
                random_forest_spark(self.train_features, self.train_labels,
                              self.test_features)
